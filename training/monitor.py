...
from gym.wrappers.monitor import detect_training_manifests, collapse_env_infos
...
#####################################################################################
# A modified Gym Monitor class:
#   - video recording
#   - wrapped environment is closed with the monitor
#   - saves StatRecorder fields
#
#   [http://hub.packtpub.com/openai-gym-environments-wrappers-and-monitors-tutorial/]
#   [http://alexandervandekleut.github.io/gym-wrappers/]
#####################################################################################
class MonitorV2(Monitor):
    ...
    def seed(self, seed=None):
        ...
        self.stats_recorder.seed = seeds[0]
        return seeds

    def is_episode_selected(self):
        return self._video_enabled()  # whether this episode was selected for rendering and model saving
...
##########################################################
# Modified Gym StatsRecorder class:
#   - environment seed at each episode for reproducibility
##########################################################
